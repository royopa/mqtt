...
/* Defines do MQTT */
#define TOPICO_PUBLISH_TEMPERATURA   "cli-mlk-001-pub/temperature" 
#define TOPICO_PUBLISH_UMIDADE       "cli-mlk-001-pub/humidity" 
#define TOPICO_PUBLISH_LUMINOSIDADE  "cli-mlk-001-pub/luminosity" 
 
#define ID_MQTT  "cli-mlk-001-pub"  //id cliente mqtt (para identificação de sessão)
